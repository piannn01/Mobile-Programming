...
class HomeView extends StatelessWidget {
  ...
  Widget _buildMahasiswaMenu() {
    return GridView.count(
      ...
      children: [
        ...
        _buildMenuIcon(Icons.holiday_village_sharp, 'Peminjaman Fasilitas', () {
  ...
  Widget _buildStaffMenu() {
    return GridView.count(
      ...
      physics: NeverScrollableScrollPhysics(),
      children: [
        _buildMenuIcon(Icons.holiday_village_sharp, 'Peminjaman Tempat', () {
          Get.toNamed('/add-room');
        }),
        _buildMenuIcon(Icons.construction, 'Peminjaman Alat', () {
          Get.toNamed('/add-tool');
        }),
        _buildMenuIcon(Icons.history, 'History Peminjaman', () {
          Get.toNamed('/history');
        }),
        _buildMenuIcon(Icons.analytics, 'Pelaporan Kerusakan', () {
          Get.toNamed('/report');
        }),
        ...
        _buildMenuIcon(Icons.analytics, 'Analytic', () {
          Get.toNamed('/analytic-view');
        }),
      ],
    );
  }
  ...
  Widget _buildDosenMenu() {
    return GridView.count(
      ...
      physics: NeverScrollableScrollPhysics(),
      children: [
        _buildMenuIcon(Icons.analytics, 'Laporan Kerusakan', () {
          Get.toNamed('/report');
        }),
        _buildMenuIcon(Icons.feedback, 'Report Generator', () {
          Get.toNamed('/report-generator');}),
        ...
        _buildMenuIcon(Icons.book, 'KRS Dosen', () {
          Get.toNamed('/krsdosen');
        }),
        _buildMenuIcon(Icons.grade, 'Transkrip Nilai', () {
          Get.toNamed('/transkrip');
        }),
        _buildMenuIcon(Icons.schedule, 'Jadwal', () {
          Get.toNamed('/scheduledosen');
        }),
        /*_buildMenuIcon(Icons.payment, 'Bayar', () {}),
      _buildMenuIcon(Icons.receipt, 'Tagihan', () {}),*/
        _buildMenuIcon(Icons.event, 'Tugas Dosen', () {
          Get.toNamed('/assignmentdosen');
        }),
      ],
    );
  }
